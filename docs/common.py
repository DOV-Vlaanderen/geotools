# -*- coding: utf-8 -*-
#
# GeoTools documentation build configuration file, created by
# sphinx-quickstart on Thu Jul  9 15:23:41 2009.
#
...
extlinks = { 
    ...
    'developer': ('https://docs.geotools.org/maintenance/developer/%s', None),
    'user': ('https://docs.geotools.org/maintenance/userguide/%s', None),
    'api': ('https://docs.geotools.org/maintenance/javadocs/%s', None),
...
latex_documents = [
  ('index', 'GeoTools.tex', u'GeoTools Documentation',
   u'GeoTools', 'manual'),
]
