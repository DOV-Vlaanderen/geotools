...
/**
 * 
 * Builds a list via iteration. An index property name, a count (number of iterations)
 * and an (indexed) expression must be provided. The result is a list containing the evaluated
